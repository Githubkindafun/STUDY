...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        public Vector3 RestPositionOffset = Vector3.zero;
        public Vector3 RestRotationOffset = Vector3.zero;
        ...
        void Update()
        {
            ...
            // nakładamy shakeof bez nadpisywania orginalnego przemieszczenia kamery
            transform.localPosition = RestPositionOffset + posAddShake;
            transform.localEulerAngles = RestRotationOffset + rotAddShake;
        }
